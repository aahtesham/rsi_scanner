...
# CONFIGURATION
# -------------------------------
TRADE_AMOUNT_USDT = 10       # how much USDT to spend per trade
TAKE_PROFIT_PCT   = 0.02     # 2% profit target
STOP_LOSS_PCT     = 0.01     # 1% stop loss
MAX_HOLD_MINUTES  = 60       # exit after 60 min no matter what
...
def scan():
    ...
    # in scan(), after matches loop:
    for m in matches:
        open_trade(m["symbol"], m["live_rsi"])
